...
int run_process_track_tree_draw(const char *fnlist = 0, const char *commentstr = 0)
{
  ...
  if(debugl)std::cout << "Total number of events: " << nevproc << std::endl;
//   int bxNumber = 0; /// bunch crossing number
//   int multiplicity[10000][16]    = {{0},{0}};
//   int multiplicityEle[10000][16] = {{0},{0}};
//   int multiplicityGam[10000][16] = {{0},{0}};
//   int multiplicityPos[10000][16] = {{0},{0}};
  
//   int multiplicitySignalEle[10000][16] = {{0},{0}};
//   int multiplicitySignalGam[10000][16] = {{0},{0}};
//   int multiplicitySignalPos[10000][16] = {{0},{0}};
//   
//   int multiplicityBackgroundEle[10000][16] = {{0},{0}};
//   int multiplicityBackgroundGam[10000][16] = {{0},{0}};
//   int multiplicityBackgroundPos[10000][16] = {{0},{0}};
...
//     }
  ...
  for (size_t ii = 0; ii < ntrck; ++ii) {
    ...
    if (det_id >= 1000 && det_id <= 1015) {
      ...
      lhist->FillHistW("tracking_planes_vtx_z_track_e", det, vtx_z, eneg, ev_weight);
      lhist->FillHistW("tracking_planes_vtx_x_track_e", det, vtx_x, eneg, ev_weight);
      //lhist->FillHistW("tracking_planes_vtx_x_vtx_z_track_e", det, vtx_x, vtx_z, eneg, ev_weight);
      if(eneg<=1.0){
          lhist->FillHistW("tracking_planes_track_e_zoomed", det, eneg, ev_weight);
          lhist->FillHistW("tracking_planes_vtx_z_track_e_zoomed", det, vtx_z, eneg, ev_weight);
          lhist->FillHistW("tracking_planes_vtx_x_track_e_zoomed", det, vtx_x, eneg, ev_weight);
          //hist->FillHistW("tracking_planes_vtx_x_vtx_z_track_e_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
      }
      if(eneg<=0.05){
          lhist->FillHistW("tracking_planes_track_e_morezoomed", det, eneg, ev_weight);
          lhist->FillHistW("tracking_planes_vtx_z_track_e_morezoomed", det, vtx_z, eneg, ev_weight);
          lhist->FillHistW("tracking_planes_vtx_x_track_e_morezoomed", det, vtx_x, eneg, ev_weight);
          //lhist->FillHistW("tracking_planes_vtx_x_vtx_z_track_e_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
      }
...
//         multiplicityEle[bxNumber][det]++;
        ...
        if(track_id==1){
            ...
            lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_electrons", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_electrons", det, vtx_x, eneg, ev_weight);
            //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_electrons", det, vtx_x, vtx_z, eneg, ev_weight);
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_signal_track_e_electrons_zoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_electrons_zoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_electrons_zoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_electrons_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
            if(eneg<=0.05){
                lhist->FillHistW("tracking_planes_signal_track_e_electrons_morezoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_electrons_morezoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_electrons_morezoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_electrons_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
        ...
        if(track_id!=1){
            ...
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_electrons", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_electrons", det, vtx_x, eneg, ev_weight);
            //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_electrons", det, vtx_x, vtx_z, eneg, ev_weight);
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_background_track_e_electrons_zoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_track_e_electrons_zoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_x_track_e_electrons_zoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_electrons_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
            if(eneg<=0.05){
                lhist->FillHistW("tracking_planes_background_track_e_electrons_morezoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_track_e_electrons_morezoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_x_track_e_electrons_morezoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_electrons_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
...
//         multiplicityPos[bxNumber][det]++;
        ...
        if(track_id==1){
            ...
            lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_positrons", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_positrons", det, vtx_x, eneg, ev_weight);
            //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_positrons", det, vtx_x, vtx_z, eneg, ev_weight);
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_signal_track_e_positrons_zoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_positrons_zoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_positrons_zoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_positrons_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
            if(eneg<=0.05){
                lhist->FillHistW("tracking_planes_signal_track_e_positrons_morezoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_positrons_morezoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_positrons_morezoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_positrons_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
        ...
        if(track_id!=1){
            //multiplicityBackgroundPos[bxNumber][det]++;
            ...
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_positrons", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_positrons", det, vtx_x, eneg, ev_weight);
            //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_positrons", det, vtx_x, vtx_z, eneg, ev_weight);
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_background_track_e_positrons_zoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_track_e_positrons_zoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_x_track_e_positrons_zoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_positrons_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
            if(eneg<=0.05){
                lhist->FillHistW("tracking_planes_background_track_e_positrons_morezoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_track_e_positrons_morezoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_x_track_e_positrons_morezoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_positrons_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
...
//         multiplicityGam[bxNumber][det]++;
        ...
        if(track_id==1){
            ...
            lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_gamma", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_gamma", det, vtx_x, eneg, ev_weight);
            //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_gamma", det, vtx_x, vtx_z, eneg, ev_weight);
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_signal_track_e_gamma_zoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_gamma_zoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_gamma_zoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_gamma_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
            if(eneg<=0.05){
                lhist->FillHistW("tracking_planes_signal_track_e_gamma_morezoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_z_track_e_gamma_morezoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_signal_vtx_x_track_e_gamma_morezoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_signal_vtx_x_vtx_z_track_e_gamma_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
        ...
        if(track_id!=1){
            //multiplicityBackgroundGam[bxNumber][det]++;
            ...
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_gamma", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_gamma", det, vtx_x, eneg, ev_weight);
            //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_gamma", det, vtx_x, vtx_z, eneg, ev_weight);
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_background_track_e_gamma_zoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_track_e_gamma_zoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_x_track_e_gamma_zoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_gamma_zoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
            if(eneg<=0.05){
                lhist->FillHistW("tracking_planes_background_track_e_gamma_morezoomed", det, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_track_e_gamma_morezoomed", det, vtx_z, eneg, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_x_track_e_gamma_morezoomed", det, vtx_x, eneg, ev_weight);
                //lhist->FillHistW("tracking_planes_background_vtx_x_vtx_z_track_e_gamma_morezoomed", det, vtx_x, vtx_z, eneg, ev_weight);
            }
...
//    lhist->DrawHist2D_BT15("ip_n_gamma_n_electrons_scint", "ip_n_gamma_n_electrons_scint", "N_gamma", "N_e", "N", "colz");
  ...
  for(int bxNum=0; bxNum < nbx; ++bxNum){
    for(int kk=0; kk < 16; ++kk){
        lhist->SetBinHist("tracking_planes_track_multiplicity", kk, bxNum+1, multiplicity[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_track_multiplicity_electrons", kk, bxNum+1, multiplicityEle[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_track_multiplicity_gamma", kk, bxNum+1, multiplicityGam[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_track_multiplicity_positrons", kk, bxNum+1, multiplicityPos[bxNum+1][kk]);
        
        lhist->SetBinHist("tracking_planes_signal_track_multiplicity_electrons", kk, bxNum+1, multiplicitySignalEle[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_signal_track_multiplicity_gamma", kk, bxNum+1, multiplicitySignalGam[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_signal_track_multiplicity_positrons", kk, bxNum+1, multiplicitySignalPos[bxNum+1][kk]);
        
        lhist->SetBinHist("tracking_planes_background_track_multiplicity_electrons", kk, bxNum+1, multiplicityBackgroundEle[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_background_track_multiplicity_gamma", kk, bxNum+1, multiplicityBackgroundGam[bxNum+1][kk]); 
        lhist->SetBinHist("tracking_planes_background_track_multiplicity_positrons", kk, bxNum+1, multiplicityBackgroundPos[bxNum+1][kk]);
    }
  }
  */
  /// normalizing to BX
...
//   lhist->SetLog(c2);
  ...
  "tracking_planes_vtx_z_track_e",
  "tracking_planes_vtx_x_track_e",
  //"tracking_planes_vtx_x_vtx_z_track_e",
  "tracking_planes_track_e_zoomed", 
  "tracking_planes_vtx_z_track_e_zoomed",
  "tracking_planes_vtx_x_track_e_zoomed",
  //"tracking_planes_vtx_x_vtx_z_track_e_zoomed",
  "tracking_planes_track_e_morezoomed", 
  "tracking_planes_vtx_z_track_e_morezoomed",
  "tracking_planes_vtx_x_track_e_morezoomed",
  //"tracking_planes_vtx_x_vtx_z_track_e_morezoomed",
  ...
  "tracking_planes_signal_vtx_z_track_e_positrons",
  "tracking_planes_signal_vtx_x_track_e_positrons",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_positrons",
  "tracking_planes_signal_track_e_positrons_zoomed", 
  "tracking_planes_signal_vtx_z_track_e_positrons_zoomed",
  "tracking_planes_signal_vtx_x_track_e_positrons_zoomed",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_positrons_zoomed",
  "tracking_planes_signal_track_e_positrons_morezoomed", 
  "tracking_planes_signal_vtx_z_track_e_positrons_morezoomed",
  "tracking_planes_signal_vtx_x_track_e_positrons_morezoomed",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_positrons_morezoomed",
  ...
  "tracking_planes_signal_vtx_z_track_e_electrons",
  "tracking_planes_signal_vtx_x_track_e_electrons",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_electrons",
  "tracking_planes_signal_track_e_electrons_zoomed", 
  "tracking_planes_signal_vtx_z_track_e_electrons_zoomed",
  "tracking_planes_signal_vtx_x_track_e_electrons_zoomed",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_electrons_zoomed",
  "tracking_planes_signal_track_e_electrons_morezoomed", 
  "tracking_planes_signal_vtx_z_track_e_electrons_morezoomed",
  "tracking_planes_signal_vtx_x_track_e_electrons_morezoomed",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_electrons_morezoomed",
  ...
  "tracking_planes_signal_vtx_z_track_e_gamma",
  "tracking_planes_signal_vtx_x_track_e_gamma",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_gamma",
  "tracking_planes_signal_track_e_gamma_zoomed", 
  "tracking_planes_signal_vtx_z_track_e_gamma_zoomed",
  "tracking_planes_signal_vtx_x_track_e_gamma_zoomed",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_gamma_zoomed",
  "tracking_planes_signal_track_e_gamma_morezoomed", 
  "tracking_planes_signal_vtx_z_track_e_gamma_morezoomed",
  "tracking_planes_signal_vtx_x_track_e_gamma_morezoomed",
  //"tracking_planes_signal_vtx_x_vtx_z_track_e_gamma_morezoomed",
  ...
  "tracking_planes_background_vtx_z_track_e_positrons",
  "tracking_planes_background_vtx_x_track_e_positrons",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_positrons",
  "tracking_planes_background_track_e_positrons_zoomed", 
  "tracking_planes_background_vtx_z_track_e_positrons_zoomed",
  "tracking_planes_background_vtx_x_track_e_positrons_zoomed",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_positrons_zoomed",
  "tracking_planes_background_track_e_positrons_morezoomed", 
  "tracking_planes_background_vtx_z_track_e_positrons_morezoomed",
  "tracking_planes_background_vtx_x_track_e_positrons_morezoomed",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_positrons_morezoomed",
  ...
  "tracking_planes_background_vtx_z_track_e_electrons",
  "tracking_planes_background_vtx_x_track_e_electrons",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_electrons",
  "tracking_planes_background_track_e_electrons_zoomed", 
  "tracking_planes_background_vtx_z_track_e_electrons_zoomed",
  "tracking_planes_background_vtx_x_track_e_electrons_zoomed",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_electrons_zoomed",
  "tracking_planes_background_track_e_electrons_morezoomed", 
  "tracking_planes_background_vtx_z_track_e_electrons_morezoomed",
  "tracking_planes_background_vtx_x_track_e_electrons_morezoomed",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_electrons_morezoomed",
  ...
  "tracking_planes_background_vtx_z_track_e_gamma",
  "tracking_planes_background_vtx_x_track_e_gamma",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_gamma",
  "tracking_planes_background_track_e_gamma_zoomed",
  "tracking_planes_background_vtx_z_track_e_gamma_zoomed",
  "tracking_planes_background_vtx_x_track_e_gamma_zoomed",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_gamma_zoomed",
  "tracking_planes_background_track_e_gamma_morezoomed", 
  "tracking_planes_background_vtx_z_track_e_gamma_morezoomed",
  "tracking_planes_background_vtx_x_track_e_gamma_morezoomed",
  //"tracking_planes_background_vtx_x_vtx_z_track_e_gamma_morezoomed",
...
void CreateHistograms(MHists *mh) 
{
  ...
  mh->AddHists("tracking_planes_vtx_z_track_e", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_vtx_x_track_e", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_vtx_x_vtx_z_track_e", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_track_e_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_vtx_z_track_e_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_vtx_x_track_e_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_vtx_x_vtx_z_track_e_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_track_e_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_vtx_z_track_e_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_vtx_x_track_e_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_vtx_x_vtx_z_track_e_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
  ...
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_positrons", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_positrons", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_positrons", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_signal_track_e_positrons_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_positrons_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_positrons_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_positrons_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_signal_track_e_positrons_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_positrons_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_positrons_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_positrons_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
  ...
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_electrons", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_electrons", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_electrons", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_signal_track_e_electrons_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_electrons_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_electrons_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_electrons_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_signal_track_e_electrons_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_electrons_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_electrons_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_electrons_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
  ...
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_gamma", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_gamma", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_gamma", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_signal_track_e_gamma_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_gamma_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_gamma_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_gamma_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_signal_track_e_gamma_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_signal_vtx_z_track_e_gamma_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_signal_vtx_x_track_e_gamma_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_signal_vtx_x_vtx_z_track_e_gamma_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
  ...
  mh->AddHists("tracking_planes_background_vtx_z_track_e_positrons", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_background_vtx_x_track_e_positrons", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_positrons", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_background_track_e_positrons_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_background_vtx_z_track_e_positrons_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_background_vtx_x_track_e_positrons_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_positrons_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_background_track_e_positrons_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_background_vtx_z_track_e_positrons_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_background_vtx_x_track_e_positrons_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_positrons_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
  ...
  mh->AddHists("tracking_planes_background_vtx_z_track_e_electrons", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_background_vtx_x_track_e_electrons", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_electrons", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_background_track_e_electrons_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_background_vtx_z_track_e_electrons_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_background_vtx_x_track_e_electrons_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_electrons_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_background_track_e_electrons_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_background_vtx_z_track_e_electrons_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_background_vtx_x_track_e_electrons_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_electrons_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
  ...
  mh->AddHists("tracking_planes_background_vtx_z_track_e_gamma", ndet, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_background_vtx_x_track_e_gamma", ndet, 300, -3000, 3000, 2000, 0.0, 20.0);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_gamma", ndet, 300, -3000, 3000, 1000, -10000, 20000, 2000, 0.0, 20.0);
  mh->AddHists("tracking_planes_background_track_e_gamma_zoomed", ndet, 1000, 0.0, 1.0); 
  mh->AddHists("tracking_planes_background_vtx_z_track_e_gamma_zoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_background_vtx_x_track_e_gamma_zoomed", ndet, 300, -3000, 3000, 1000, 0.0, 1.0);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_gamma_zoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 1000, 0.0, 1.0);
  mh->AddHists("tracking_planes_background_track_e_gamma_morezoomed", ndet, 500, 0.0, 0.05); 
  mh->AddHists("tracking_planes_background_vtx_z_track_e_gamma_morezoomed", ndet, 1000, -10000, 20000, 1000, 0.0, 0.05); 
  mh->AddHists("tracking_planes_background_vtx_x_track_e_gamma_morezoomed", ndet, 300, -3000, 3000, 500, 0.0, 0.05);
  //mh->AddHists("tracking_planes_background_vtx_x_vtx_z_track_e_gamma_morezoomed", ndet, 300, -3000, 3000, 1000, -10000, 20000, 500, 0.0, 0.05);
